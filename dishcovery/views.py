...
from dishcovery.forms import UserForm, UserProfileForm
from django.contrib.auth import authenticate, login
from django.urls import reverse
from django.contrib.auth.decorators import login_required
from dishcovery.models import Recipe, Cuisine
from dishcovery.forms import RecipeForm
...
def recipe_details(request, recipe_id):
    recipe = get_object_or_404(Recipe, id=recipe_id)  # Fetch recipe or return 404
    return render(request, 'dishcovery_project/recipe_details.html', {'recipe': recipe})
